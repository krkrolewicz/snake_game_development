...
class Game:
    ...
    def update_all(self):
        ...
        #print(self.gameplain.gameplain)
        #self.CR.set_color(self.food.latitude - 1, self.food.longitude-1, self.CR.lifecolor.get(self.gameplain.gameplain[self.food.latitude, self.food.longitude])) #rysujemy komórkę odpowiednim dla niej kolorem
    ...
    def order_move(self):
        self.gamesnake.move()
        #self.gameplain.obtain_pixels({"snake": self.gamesnake.snakepart_location, "food": self.food.coords})
        #self.gameplain.obtain_pixels(self.food.coords, "other")
